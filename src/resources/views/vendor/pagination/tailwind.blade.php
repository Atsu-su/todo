        ...
        <div class="">
            ...
            <div>
                <span class="">
                    {{-- Previous Page Link --}}
                    @if ($paginator->onFirstPage())
                        <div style="width: 20px; height: 20px;" aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
                    ...
                    @else
                        <div style="width: 20px; height: 20px;" aria-disabled="true" aria-label="{{ __('pagination.next') }}">
